...
func (c *auditServiceClient) Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedAuditServiceServer) Log(context.Context, *LogRequest) (*emptypb.Empty, error) {
