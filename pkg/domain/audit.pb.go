...
const (
	Entities_USER Entities = 0
	Entities_BOOK Entities = 1
)

// Enum value maps for Entities.
var (
	Entities_name = map[int32]string{
		0: "USER",
		1: "BOOK",
	}
	Entities_value = map[string]int32{
		"USER": 0,
		"BOOK": 1,
	}
)

func (x Entities) Enum() *Entities {
	p := new(Entities)
	*p = x
	return p
}
...
func (Entities) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_audit_proto_enumTypes[0].Descriptor()
}

func (Entities) Type() protoreflect.EnumType {
	return &file_proto_audit_proto_enumTypes[0]
}

func (x Entities) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Entities.Descriptor instead.
func (Entities) EnumDescriptor() ([]byte, []int) {
...
const (
	Actions_REGISTER Actions = 0
	Actions_LOGIN    Actions = 1
	Actions_CREATE   Actions = 2
	Actions_UPDATE   Actions = 3
	Actions_GET      Actions = 4
	Actions_DELETE   Actions = 5
)
...
type LogRequest struct {
	...
	Action    Actions                `protobuf:"varint,1,opt,name=action,proto3,enum=audit.Actions" json:"action,omitempty"`
	Entity    Entities               `protobuf:"varint,2,opt,name=entity,proto3,enum=audit.Entities" json:"entity,omitempty"`
...
func (x *LogRequest) GetAction() Actions {
	if x != nil {
		return x.Action
	}
	return Actions_REGISTER
}

func (x *LogRequest) GetEntity() Entities {
	if x != nil {
		return x.Entity
	}
...
var file_proto_audit_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb4, 0x01, 0x0a, 0x0a, 0x4c, 0x6f, 0x67,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2e,
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x27, 0x0a, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x0f, 0x2e, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2e, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73,
	...
	0x53, 0x45, 0x52, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x42, 0x4f, 0x4f, 0x4b, 0x10, 0x01, 0x2a,
	...
	0x32, 0x40, 0x0a, 0x0c, 0x41, 0x75, 0x64, 0x69, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x30, 0x0a, 0x03, 0x4c, 0x6f, 0x67, 0x12, 0x11, 0x2e, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2e,
	0x4c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70,
	0x74, 0x79, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2e, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x64, 0x6f, 0x6d,
...
var file_proto_audit_proto_goTypes = []interface{}{
	(Entities)(0),                 // 0: audit.Entities
	(Actions)(0),                  // 1: audit.Actions
	(*LogRequest)(nil),            // 2: audit.LogRequest
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),         // 4: google.protobuf.Empty
}
var file_proto_audit_proto_depIdxs = []int32{
	1, // 0: audit.LogRequest.action:type_name -> audit.Actions
	0, // 1: audit.LogRequest.entity:type_name -> audit.Entities
	3, // 2: audit.LogRequest.timestamp:type_name -> google.protobuf.Timestamp
	2, // 3: audit.AuditService.Log:input_type -> audit.LogRequest
	4, // 4: audit.AuditService.Log:output_type -> google.protobuf.Empty
